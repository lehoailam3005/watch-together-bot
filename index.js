...
client.on("message", async message => {
    ...
    if (message.mentions.has(client.user.id)) {
        ...
        color: 3447003,
        title: "to get started type `dst!watch <channel ID>`"
        }});
    }
    ...
    if (cmd === "watch") {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            .then(invite => {
                ...
                message.channel.send(`✅ | Click here to start **YouTube Together** in ${channel.name}: <https://discord.gg/${invite.code}>    |*made by cpt.motchy*`);
            })
            .catch(e => {
                message.channel.send("❌ | Could not start **YouTube Together**!  |*made by cpt.motchy*");
            })
    }
